...
| v1.1.0 | 2025-12-28 | 기능분석 L1/L2/L3 분리 워크시트, 데이터 원자성 |
| v1.2.0 | 2025-12-28 | 구조분석 UX 개선, 모달 삭제 기능 추가 |
...
| 항목 | 변경 전 | 변경 후 |
|------|---------|---------|
| 완제품-메인공정 병합 | 완제품이 전체 병합 | 1:1 동일 병합 (l2Spans) |
| 4M 코드 | MT (Material) | IM (In Material) |
| 작업요소 클릭 | 인라인 수정 | 모달 팝업 |
| 작업요소 더블클릭 | 없음 | 인라인 수정 |

#### 공정/작업요소 모달 개선
- 🗑️ 삭제 버튼 추가 (빨간색, 눈에 띄게)
- 삭제 모드 토글 기능
- (현재) 표시 항목 개별/선택 삭제 지원
