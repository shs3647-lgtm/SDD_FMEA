...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│ 📋 P-FMEA 기능 분석 (3단계) - 1 Level                                       │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  ┌──────────────────────────────────────────────────────────────────────┐   │
│  │         1. 완제품 공정 기능 및 요구사항        │ 고장 영향 (FE)      │   │
│  │ 1.완제품 ├────────┬────────────────┬──────────┼────────┬────────────┤   │
│  │ 공정명  │ 구분   │ 완제품기능     │ 요구사항 │ 구분   │ 고장영향   │   │
│  ├─────────┼────────┼────────────────┼──────────┼────────┼────────────┤   │
│  │         │Your    │ 1.1 규격에     │1.1 고무  │Your    │1.1 이종재료│   │
│  │         │Plant   │ 맞는 재료 투입 │   종류   │Plant   │혼입, 물성  │   │
│  │ 타이어  │(병합)  │ (병합)         ├──────────┼────────┼────────────┤   │
│  │ 제조    │        │                │1.2 투입  │Your    │1.2 공정중  │   │
│  │ 공정    │        │                │   순서   │Plant   │이물질 오염 │   │
│  │         ├────────┼────────────────┼──────────┼────────┼────────────┤   │
│  │ (병합)  │Ship to │ 2.1 차량에     │2.2 Dry/  │Ship to │2.2 Dry/Wet │   │
│  │         │Plant   │ 적정 장착 치수 │Wet Hand  │Plant   │제동 성능   │   │
│  │         ├────────┼────────────────┼──────────┼────────┼────────────┤   │
│  │         │User    │ 3.1 외관 품질  │3.2 Mile  │User    │3.2 조기마모│   │
│  │         │        │ 유지 기능      │  age     │        │주행거리단축│   │
│  └─────────┴────────┴────────────────┴──────────┴────────┴────────────┘   │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
...
### 4.2 구분 선택 (Your Plant / Ship to Plant / User)
```
┌──────────────────┐
│ 구분 선택     ▼  │
├──────────────────┤
│ ○ Your Plant     │ ← 자사 공정 영향
│ ○ Ship to Plant  │ ← 고객사 영향
│ ○ User           │ ← 최종 사용자 영향
└──────────────────┘
```
