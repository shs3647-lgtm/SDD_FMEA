...
| 10개 컬럼 표시 | ✅ | 공정번호/공정명/공정설명/설비금형JIG/제품특성/공정특성/제품공정사양/평가방법/관리방법/대응계획 |
| 컬럼 클릭 선택 | ✅ | 노란색 강조 + ✓ 표시 |
| 전체 삭제 | ✅ | 모든 데이터 삭제 |
| 행 삭제 | ✅ | 선택된 행 삭제 |
| 컬럼 전체삭제 | ✅ | 선택된 컬럼의 모든 데이터 삭제 |
| 컬럼 선택삭제 | ✅ | 선택된 행의 해당 컬럼만 삭제 |
| 전체 템플릿 다운로드 | ✅ | CP_전체_템플릿.csv |
| 개별 템플릿 다운로드 | ✅ | CP_개별_[항목명]_템플릿.csv |
| 전체/개별 Import | ✅ | CSV/Excel 파일 Import |
