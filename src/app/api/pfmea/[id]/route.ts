...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        fmeaId,
        fmeaNo: fmeaRegistration?.fmeaNo || fmeaId,
        partName: fmeaRegistration?.partName || projectInfo?.productName || '',
        customer: fmeaRegistration?.customer || projectInfo?.customerName || '',
        project: projectInfo,
        l2: l2Data,
