        ...
        <table className="w-full border-collapse text-xs">
          <tbody>
            ...
            <tr className="bg-[#e3f2fd]" style={{ height: '32px' }}>
              <td className={headerCell} style={{ width: '10%' }}>회사 명</td>
              <td className={`${inputCell}`} style={{ width: '15%' }}>
              ...
              <td className={headerCell} style={{ width: '10%' }}>회사에 의해 결정됨</td>
            </tr>
            
            {/* 2행 - 흰색 */}
            <tr className="bg-white" style={{ height: '32px' }}>
