    ...
    <div className="min-h-screen bg-[#f0f0f0] p-3 font-[Malgun_Gothic]">
      ...
      <div className="bg-white rounded border border-gray-300">
        <table className="w-full border-collapse text-xs">
          <thead>
            <tr>
              <th className="bg-[#00587a] text-white px-1 py-1.5 border border-white font-semibold text-center align-middle" style={{ width: '30px' }}>
                <input
                  type="checkbox"
          ...
          <tbody>
            {filteredProjects.map((p, index) => (
              <tr key={p.id} className={`${index % 2 === 0 ? 'bg-[#e3f2fd]' : 'bg-white'} hover:bg-blue-100`} style={{ height: '28px' }}>
