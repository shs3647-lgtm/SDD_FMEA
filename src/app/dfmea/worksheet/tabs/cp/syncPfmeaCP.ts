 ...
 * 
 * 연동 필드:
 * - 공정번호/공정명: PFMEA L2 ↔ CP processNo/processName
 * - 작업요소: PFMEA L3 ↔ CP workElement
 * - 제품특성: PFMEA productChar ↔ CP productChar
 * - 공정특성: PFMEA processChar ↔ CP processChar
 * - 특별특성: PFMEA specialChar ↔ CP specialChar
 * - 관리방법: PFMEA prevention/detection ↔ CP controlMethod
 */
