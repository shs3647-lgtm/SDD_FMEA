          ...
          {existingRelations.length > 0 && (
            <div>
              ...
              <table className="w-full text-sm" style={{ borderCollapse: 'collapse' }}>
                <thead>
                  <tr>
                    <th className="bg-red-500 text-white px-3 py-2 text-left" style={{ border: '1px solid #999' }}>L1 완제품</th>
                    <th className="bg-[#00587a] text-white px-3 py-2 text-center w-12" style={{ border: '1px solid #999' }}></th>
                    <th className="bg-yellow-500 text-white px-3 py-2 text-left" style={{ border: '1px solid #999' }}>L2 공정</th>
                    <th className="bg-[#00587a] text-white px-3 py-2 text-center w-12" style={{ border: '1px solid #999' }}></th>
                    <th className="bg-green-500 text-white px-3 py-2 text-left" style={{ border: '1px solid #999' }}>L3 작업요소</th>
