      ...
      <div className="max-h-[250px] overflow-y-auto">
        <table className="w-full text-sm" style={{ borderCollapse: 'collapse' }}>
          <thead className="sticky top-0">
            <tr>
              <th className="bg-[#00587a] text-white font-bold px-3 py-2 text-center w-20" style={{ border: '1px solid #999' }}>카테고리</th>
              <th className="bg-[#00587a] text-white font-bold px-3 py-2 text-left" style={{ border: '1px solid #999' }}>항목</th>
            </tr>
          </thead>
          <tbody>
            {COMMON_CATEGORIES.map((cat, catIdx) => {
              ...
              return (
                <tr key={cat.code}>
                  ...
                  <td className="bg-[#00587a] text-white font-bold px-3 py-2 text-center align-top" style={{ border: '1px solid #999' }}>
                  ...
                  {/* 항목 열 - 짝수/홀수 배경 */}
                  <td className={`px-3 py-2 ${catIdx % 2 === 0 ? 'bg-white' : 'bg-[#e0f2fb]'}`} style={{ border: '1px solid #999' }}>
          ...
          <div className="space-y-4 py-4">
            <table className="w-full text-sm" style={{ borderCollapse: 'collapse' }}>
              <tbody>
                ...
                <tr>
                  <td className="bg-[#00587a] text-white font-bold px-3 py-2" style={{ border: '1px solid #999' }}>항목명 *</td>
                ...
                <tr>
                  <td className="bg-[#00587a] text-white font-bold px-3 py-2" style={{ border: '1px solid #999' }}>설명</td>
                  <td className="bg-white px-3 py-2" style={{ border: '1px solid #999' }}>
                    <Input
                ...
                <tr>
                  <td className="bg-[#00587a] text-white font-bold px-3 py-2" style={{ border: '1px solid #999' }}>고장원인</td>
                  <td className="bg-[#e0f2fb] px-3 py-2" style={{ border: '1px solid #999' }}>
                    <Input
