...
import { ImportRowData, GeneratedRelation } from './types';
import { importColumns, sampleImportData, generateRelations, calculateStats } from './mock-data';
...
export default function PFMEAImportPage() {
  ...
  const selectedRelation = relations.find(r => r.processNo === selectedProcessNo);
