      ...
      <div className="max-h-[350px] overflow-y-auto">
        <table className="w-full text-sm" style={{ borderCollapse: 'collapse' }}>
          <thead className="sticky top-0">
            <tr>
              <th className="bg-[#00587a] text-white px-2 py-2 w-10 text-center" style={{ border: '1px solid #999' }}>
                <input
                  type="checkbox"
              ...
              <th className="bg-[#00587a] text-white px-2 py-2 w-10" style={{ border: '1px solid #999' }}></th>
              <th className="bg-[#00587a] text-white px-3 py-2 text-left" style={{ border: '1px solid #999' }}>
                {SUB_TAB_LABELS[subTab] || subTab}
              </th>
              <th className="bg-[#00587a] text-white px-2 py-2 w-16 text-center" style={{ border: '1px solid #999' }}></th>
            </tr>
          </thead>
          <tbody>
            {filteredData.length === 0 ? (
              ...
              filteredData.map((item, index) => (
                ...
                >
                  <td className="px-2 py-2 text-center" style={{ border: '1px solid #ddd' }}>
                    <input
                      type="checkbox"
                  ...
                  <td className="px-2 py-2 cursor-move text-center" style={{ border: '1px solid #ddd' }}>
                    <GripVertical className="h-4 w-4 text-gray-400 inline" />
                  </td>
                  <td className="px-3 py-2" style={{ border: '1px solid #ddd' }}>
                    {editingId === item.id ? (
