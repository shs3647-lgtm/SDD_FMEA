          ...
          {processChains.length > 0 && (
            <div>
              ...
              <table className="w-full text-sm" style={{ borderCollapse: 'collapse' }}>
                <thead>
                  <tr>
                    <th className="bg-orange-600 text-white px-3 py-2 text-left" style={{ border: '1px solid #999' }}>고장원인 (FC)</th>
                    <th className="bg-[#00587a] text-white px-3 py-2 text-center w-8" style={{ border: '1px solid #999' }}></th>
                    <th className="bg-red-500 text-white px-3 py-2 text-left" style={{ border: '1px solid #999' }}>고장형태 (FM)</th>
                    <th className="bg-[#00587a] text-white px-3 py-2 text-center w-8" style={{ border: '1px solid #999' }}></th>
                    <th className="bg-red-700 text-white px-3 py-2 text-left" style={{ border: '1px solid #999' }}>고장영향 (FE)</th>
                    <th className="bg-green-600 text-white px-3 py-2 text-left" style={{ border: '1px solid #999' }}>예방(PC)</th>
                    <th className="bg-blue-600 text-white px-3 py-2 text-left" style={{ border: '1px solid #999' }}>검출(DC)</th>
                    <th className="bg-[#00587a] text-white px-3 py-2 text-center w-12" style={{ border: '1px solid #999' }}>삭제</th>
                  </tr>
                </thead>
                <tbody>
                  {processChains.map((chain, idx) => (
                    <tr key={chain.id}>
                      ...
                      <td className={`px-3 py-2 text-xs ${idx % 2 === 0 ? 'bg-white' : 'bg-[#e0f2fb]'}`} style={{ border: '1px solid #999' }}>
