...
export function AllViewHeader() {
  return (
    <>
      ...
      <tr>
        {/* 구조분석 (3 서브그룹) */}
        <th colSpan={1} className="p-0.5 h-5 font-bold text-xs text-center border border-[#ccc] bg-[#1976d2]">1. 완제품 공정명</th>
        <th colSpan={1} className="p-0.5 h-5 font-bold text-xs text-center border border-[#ccc] bg-[#1976d2]">2. 메인 공정명</th>
