  ...
  return (
    <>
      ...
      <tr>
        ...
        <th colSpan={3} style={{ background: '#1b5e20', color: 'white', border: `1px solid ${COLORS.line}`, padding: '4px', height: '28px', fontWeight: 900, textAlign: 'center', fontSize: '11px' }}>
          1. 완제품 기능 및 요구사항 (L1)
        </th>
        <th colSpan={2} style={{ background: '#2e7d32', color: 'white', border: `1px solid ${COLORS.line}`, padding: '4px', height: '28px', fontWeight: 900, textAlign: 'center', fontSize: '11px' }}>
          2. 메인공정 기능 및 제품특성 (L2)
        </th>
        <th colSpan={2} style={{ background: '#388e3c', color: 'white', border: `1px solid ${COLORS.line}`, padding: '4px', height: '28px', fontWeight: 900, textAlign: 'center', fontSize: '11px' }}>
          3. 작업요소 기능 및 공정특성 (L3)
        </th>
      </tr>
      ...
      <tr style={{ position: 'sticky', top: '28px', zIndex: 20, background: '#fff' }}>
        ...
        <th style={{ background: '#c8e6c9', border: `1px solid ${COLORS.line}`, padding: '2px 4px', height: '24px', fontWeight: 700, fontSize: '10px' }}>구분</th>
        <th style={{ background: '#c8e6c9', border: `1px solid ${COLORS.line}`, padding: '2px 4px', height: '24px', fontWeight: 700, fontSize: '10px' }}>완제품기능</th>
        <th style={{ background: '#c8e6c9', border: `1px solid ${COLORS.line}`, padding: '2px 4px', height: '24px', fontWeight: 700, fontSize: '10px' }}>요구사항</th>
