      ...
      <table style={evalTableStyle}>
        <thead style={stickyTheadStyle}>
          ...
          <tr>
            ...
            {visibleSteps.includes(3) && <><th colSpan={3} style={subHeaderCellStyle(COLORS.function.header)}>1. 완제품 기능</th><th colSpan={2} style={subHeaderCellStyle(COLORS.function.header)}>2. 공정기능/제품특성</th><th colSpan={3} style={subHeaderCellStyle(COLORS.function.header)}>3. 작업요소기능/공정특성</th></>}
          ...
          {/* 3행: 컬럼명 */}
          <tr>
            {visibleSteps.includes(2) && <><th style={subHeaderCellStyle(COLORS.structure.cell)}>완제품공정명</th><th style={subHeaderCellStyle(COLORS.structure.cell)}>NO+공정명</th><th style={subHeaderCellStyle(COLORS.structure.cell)}>4M</th><th style={subHeaderCellStyle(COLORS.structure.cell)}>작업요소</th></>}
            {visibleSteps.includes(3) && <><th style={subHeaderCellStyle(COLORS.function.cell)}>구분</th><th style={subHeaderCellStyle(COLORS.function.cell)}>제품 기능</th><th style={subHeaderCellStyle(COLORS.function.cell)}>요구사항</th><th style={subHeaderCellStyle(COLORS.function.cell)}>공정기능</th><th style={subHeaderCellStyle(COLORS.function.cell)}>제품특성</th><th style={subHeaderCellStyle(COLORS.function.cell)}>4M</th><th style={subHeaderCellStyle(COLORS.function.cell)}>작업요소기능</th><th style={subHeaderCellStyle(COLORS.function.cell)}>공정특성</th></>}
            {visibleSteps.includes(4) && <><th style={subHeaderCellStyle(COLORS.failure.cell)}>구분</th><th style={subHeaderCellStyle(COLORS.failure.cell)}>고장영향(FE)</th><th style={subHeaderCellStyle(COLORS.failure.cell)}>심각도</th><th style={subHeaderCellStyle(COLORS.failure.cell)}>고장형태(FM)</th><th style={subHeaderCellStyle(COLORS.failure.cell)}>작업요소</th><th style={subHeaderCellStyle(COLORS.failure.cell)}>고장원인(FC)</th></>}
