    ...
    <>
      <table style={evalTableStyle}>
        <thead style={stickyTheadStyle}>
          ...
          {/* 3행: 컬럼명 */}
          <tr>
            {visibleSteps.includes(2) && <><th style={subHeaderCellStyle(COLORS.structure.cell)}>완제품공정명</th><th style={subHeaderCellStyle(COLORS.structure.cell)}>NO+공정명</th><th style={subHeaderCellStyle(COLORS.structure.cell)}>4M</th><th style={subHeaderCellStyle(COLORS.structure.cell)}>부품</th></>}
