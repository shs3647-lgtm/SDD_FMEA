 ...
 * - 작업요소 ↔ PFMEA L3 작업요소 (workElement)
 * - 제품특성 ↔ PFMEA 제품특성 (productChar)
 * - 공정특성 ↔ PFMEA 공정특성 (processChar)
...
export const CP_COLUMNS = [
  ...
  // 관리항목 (7열)
  { key: 'ep', label: 'EP', width: 30, group: '관리항목' },
  { key: 'autoInspect', label: '자동검사', width: 50, group: '관리항목' },
