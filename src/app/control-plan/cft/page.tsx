    ...
    <>
      ...
      <div className="min-h-screen bg-[#f0f0f0] px-3 py-3 pt-9 font-[Malgun_Gothic]">
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <h1 className="text-base font-bold text-gray-800">CP CFT 등록</h1>
            ...
            <table className="w-full border-collapse text-xs min-w-[1000px]">
              <thead>
                <tr className="bg-[#0d9488] text-white" style={{ height: '28px' }}>
                  ...
                  <th className="border border-white px-2 py-1 text-center align-middle w-24">성명</th>
                  <th className="border border-white px-2 py-1 text-center align-middle w-28">부서</th>
                  <th className="border border-white px-2 py-1 text-center align-middle w-20">직급</th>
                  <th className="border border-white px-2 py-1 text-center align-middle w-24">역할</th>
                  <th className="border border-white px-2 py-1 text-center align-middle w-40">이메일</th>
                  <th className="border border-white px-2 py-1 text-center align-middle w-28">연락처</th>
                  <th className="border border-white px-2 py-1 text-center align-middle w-24">참여일</th>
                  <th className="border border-white px-2 py-1 text-center align-middle w-20">상태</th>
                </tr>
              </thead>
              <tbody>
