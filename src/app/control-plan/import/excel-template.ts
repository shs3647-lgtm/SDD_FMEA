...
const CP_SAMPLE_DATA: Record<string, string[][]> = {
  ...
  '관리방법': [
    ['10', '자재입고', '육안검사', 'n=3', '매입고', '검사원', ''],
    ['20', '수입검사', 'Mooney Viscometer', 'n=5', '매Lot', '검사원', '품질팀장'],
    ['30', 'MB Mixing', 'Rheometer', 'n=3', '매Batch', '작업자', '공정팀장'],
    ['40', 'FM Mixing', 'Rheometer', 'n=3', '매Batch', '작업자', '공정팀장'],
    ['50', '압출', '두께 측정', 'n=5', '매시', '작업자', ''],
    ['60', '압연', '폭 측정', 'n=5', '매Lot', '작업자', ''],
    ['80', '성형', '육안검사', 'n=1', '매개', '작업자', ''],
    ['90', '가류', '가류도 측정', 'n=3', '매Lot', '작업자', '품질팀장'],
    ['100', '완성검사', 'X-ray 검사', '전수', '매개', '검사원', '품질팀장'],
  ],
  '대응계획': [
